...
public class PersonControllerTest {
    ...
    public void testAddPerson_MissingRequiredFields() throws Exception {
        // Create an incomplete PersonDTO (e.g., missing phone number)
    ...
    public void testAddPerson_MedicalRecordNotFound() throws Exception {
        // Assuming the firstName and lastName do not match in medical records or fire stations
    ...
    @Test
    public void getAllPersons_InternalServerError() throws Exception {	
