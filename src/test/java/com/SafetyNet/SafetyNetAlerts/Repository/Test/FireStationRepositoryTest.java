...
public class FireStationRepositoryTest {
	...
	//  Test: Fetch data for fire stations
	@Test
	...
	//  Test: fails due to missing "firestations" node
	@Test
	...
	// Test: fails due to empty fire stations
	@Test
	void testGetAllHomesServedByStation_Failure_EmptyFireStations() throws IOException {
		...
		ArrayNode fireStationsArray = nodeFactory.arrayNode(); 
		((ObjectNode) rootNode).set("firestations", fireStationsArray); 
	...
	//  Test: Fetch data for fire stations by address
	@Test
	...
	void testMedicalRecordMissing() throws IOException {
		...
		String jsonString = "{ \"persons\": [{\"firstName\": \"John\", \"lastName\": \"Doe\", \"address\": \"" + address + "\", \"phone\": \"123-456-7890\"}], " +
				"\"medicalrecords\": [], " + 
				"\"firestations\": [{\"address\": \"" + address + "\", \"station\": \"1\"}] }"; 
		JsonNode rootNode = objectMapper.readTree(jsonString);
	...
	//  Test: Successfully fetch data for fire station
	@Test
	...
	//  Test: fails when no matching station is found
	@Test
	...
	//  Test: fails when no matching person is found
	@Test
	...
	// Test: returns empty result when no records exist
	@Test
	void testGetChildrenLivingAtThisAddress_Failure_NoRecords() throws IOException {
		...
		ObjectNode personsNode = nodeFactory.objectNode(); 
		((ObjectNode) rootNode).set("persons", personsNode); 


		when(informationRepository.readFile()).thenReturn(rootNode);


		String fireStationId = "stationId"; 
		Object result = fireStationRepository.getChildrenLivingAtThisAddress(fireStationId); 
